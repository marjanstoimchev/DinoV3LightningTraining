...
# DINOv3 Linear Evaluation Script - Oxford Pets
# Linear evaluation (frozen backbone) of pre-trained SSL model on Oxford Pets dataset
# Checkpoints saved to: output/oxford_pets/checkpoints/classification/lineareval/
