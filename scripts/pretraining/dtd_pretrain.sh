#!/bin/bash
# =============================================================================
# DINOv3 Pretraining Script - DTD
# =============================================================================
# Self-supervised pretraining on DTD (Describable Textures Dataset)
#
# Output structure:
#   output/dtd/checkpoints/pretraining/last.ckpt
#
# Usage:
#   # Default settings
#   ./scripts/pretraining/dtd_pretrain.sh
#
#   # Custom prototype count
#   NUM_PROTOTYPES=256 ./scripts/pretraining/dtd_pretrain.sh
#
#   # Custom GPUs
#   GPUS=0,1 ./scripts/pretraining/dtd_pretrain.sh
#
# For prototype analysis sweep, use:
#   python scripts/prototype_analysis/sweep_pretraining.py --dataset dtd --gpus 0,1,2
# =============================================================================
...
OUTPUT_DIR="${OUTPUT_DIR:-output/dtd}"
...
echo "========================================================================"
echo "DINOv3 SSL Pretraining - DTD"
echo "========================================================================"
