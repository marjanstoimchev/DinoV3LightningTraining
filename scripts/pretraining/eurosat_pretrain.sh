#!/bin/bash
# =============================================================================
# DINOv3 Pretraining Script - EuroSAT
# =============================================================================
# Self-supervised pretraining on EuroSAT dataset
#
# Output structure:
#   output/eurosat/checkpoints/pretraining/last.ckpt
#
# Usage:
#   # Default settings
#   ./scripts/pretraining/eurosat_pretrain.sh
#
#   # Custom prototype count
#   NUM_PROTOTYPES=256 ./scripts/pretraining/eurosat_pretrain.sh
#
#   # Custom GPUs
#   GPUS=0,1 ./scripts/pretraining/eurosat_pretrain.sh
#
# For prototype analysis sweep, use:
#   python scripts/prototype_analysis/sweep_pretraining.py --dataset eurosat --gpus 0,1,2
# =============================================================================
...
OUTPUT_DIR="${OUTPUT_DIR:-output/eurosat}"
...
echo "========================================================================"
echo "DINOv3 SSL Pretraining - EuroSAT"
echo "========================================================================"
