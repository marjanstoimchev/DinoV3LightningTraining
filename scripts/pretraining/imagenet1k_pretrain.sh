#!/bin/bash
# =============================================================================
# DINOv3 Pretraining Script - ImageNet-1K
# =============================================================================
# Self-supervised pretraining on ImageNet-1K dataset
#
# Output structure:
#   output/imagenet1k/checkpoints/pretraining/last.ckpt
#
# Usage:
#   # Default settings
#   ./scripts/pretraining/imagenet1k_pretrain.sh
#
#   # Custom prototype count
#   NUM_PROTOTYPES=256 ./scripts/pretraining/imagenet1k_pretrain.sh
#
#   # Custom GPUs
#   GPUS=0,1,2,3 ./scripts/pretraining/imagenet1k_pretrain.sh
#
# For prototype analysis sweep, use:
#   python scripts/prototype_analysis/sweep_pretraining.py --dataset imagenet1k --gpus 0,1,2,3
# =============================================================================
...
OUTPUT_DIR="${OUTPUT_DIR:-output/imagenet1k}"
...
echo "========================================================================"
echo "DINOv3 SSL Pretraining - ImageNet-1K"
echo "========================================================================"
