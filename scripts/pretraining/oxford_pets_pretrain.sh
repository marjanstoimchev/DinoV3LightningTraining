#!/bin/bash
# =============================================================================
# DINOv3 Pretraining Script - Oxford Pets
# =============================================================================
# Self-supervised pretraining on Oxford-IIIT Pet dataset
#
# Output structure:
#   output/oxford_pets/checkpoints/pretraining/last.ckpt
#
# Usage:
#   # Default settings
#   ./scripts/pretraining/oxford_pets_pretrain.sh
#
#   # Custom prototype count
#   NUM_PROTOTYPES=256 ./scripts/pretraining/oxford_pets_pretrain.sh
#
#   # Custom GPUs
#   GPUS=0,1 ./scripts/pretraining/oxford_pets_pretrain.sh
#
# For prototype analysis sweep, use:
#   python scripts/prototype_analysis/sweep_pretraining.py --dataset oxford_pets --gpus 0,1,2
# =============================================================================
...
OUTPUT_DIR="${OUTPUT_DIR:-output/oxford_pets}"
...
echo "========================================================================"
echo "DINOv3 SSL Pretraining - Oxford Pets"
echo "========================================================================"
