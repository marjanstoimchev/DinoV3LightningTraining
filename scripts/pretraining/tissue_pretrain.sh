#!/bin/bash
# =============================================================================
# DINOv3 Pretraining Script - Tissue
# =============================================================================
# Self-supervised pretraining on Tissue dataset
#
# Output structure:
#   output/tissue/checkpoints/pretraining/last.ckpt
#
# Usage:
#   # Default settings
#   ./scripts/pretraining/tissue_pretrain.sh
#
#   # Custom prototype count
#   NUM_PROTOTYPES=256 ./scripts/pretraining/tissue_pretrain.sh
#
#   # Custom GPUs
#   GPUS=0,1 ./scripts/pretraining/tissue_pretrain.sh
#
# For prototype analysis sweep, use:
#   python scripts/prototype_analysis/sweep_pretraining.py --dataset tissue --gpus 0,1,2
# =============================================================================
...
OUTPUT_DIR="${OUTPUT_DIR:-output/tissue}"
...
echo "========================================================================"
echo "DINOv3 SSL Pretraining - Tissue"
echo "========================================================================"
